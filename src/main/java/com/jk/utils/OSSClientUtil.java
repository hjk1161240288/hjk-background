...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIwzAGNbFS9m98";
    private String accessKeySecret = "9GXWRFEQYGBphIqa7V2bimiCy5S2hU";
    // 空间
    private String bucketName = "tableimg";
    // 文件存储目录
    private String filedir = "tableimg/";
